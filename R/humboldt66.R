...
humboldt.g2e <- function(env1, env2, sp1, sp2, reduce.env = 2, reductype = "PCA", non.analogous.environments = "NO", nae.window=5,
    ...
    if (REDUC == 5) {
        ...
        if (env1s2.rpts | env2s2.rpts | sp1s2.rpts | sp2s2.rpts == 0) {
            print("*****************************************************************")
            print("*****************************************************************")
            print("*****************************************************************")
            ...
            print("*****************************************************************")
            print("*****************************************************************")
            print("The Niche Divergence Test (NDT) is only possible if some portion of the distributions exist in shared accessible environmental-space. In this analysis there exists no shared E-space between the two taxa.  If the two species’ shared available E-space does not overlap where the focal taxa exist, then there are no analogous climates. In this situation, we recommend that your report the following:")
