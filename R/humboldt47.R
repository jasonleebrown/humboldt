...
#' ## env.reso should be the resolution of the environmental data grid
#' env.reso=0.41666669 
#' occ.sp1<-na.exclude(humboldt.sample.spp(dfsp=occ.sp1,colspxy=1:2,colspkept=NULL,dfvar=env1,colvarxy=1:2,colvar="all",resolution=env.reso))
#' occ.sp2<-na.exclude(humboldt.sample.spp(dfsp=occ.sp2,colspxy=1:2,colspkept=NULL,dfvar=env2,colvarxy=1:2,colvar="all",resolution=env.reso))
...
#' full<-humboldt.doitall(inname="full_extent", env1=reduc.vars$env1, env2=reduc.vars$env2, sp1=occ.sp1, sp2=occ.sp2, rarefy.dist=40, rarefy.units="km", env.reso=0.416669, reduce.env=0, reductype="PCA", non.analogous.environments="YES", correct.env=T, env.trim.mcp=F, mcp.buffer.sp1=200, mcp.buffer.sp2=200, col.env=e.var, e.var=c(3:num.var.e), R=100, kern.smooth=1, PROJ=F, e.reps=100, e.sample.method="points", b.reps=100, env.pca=T, nae="YES",thresh.espace.z=0.001, p.overlap=T, p.boxplot=F, p.scatter=F, run.silent=F)
#'
...
#' shared_ae<-humboldt.doitall(inname="shared_espace_ae", env1=reduc.vars$env1, env2=reduc.vars$env2, sp1=occ.sp1, sp2=occ.sp2, rarefy.dist=40, rarefy.units="km", env.reso=0.416669, reduce.env=2, reductype="PCA", non.analogous.environments="NO", correct.env=T, env.trim.mcp=T, mcp.buffer.sp1=200, mcp.buffer.sp2=200, col.env=e.var, e.var=c(3:num.var.e), R=100, kern.smooth=1, PROJ=F, e.reps=100, e.sample.method="points", b.reps=100, env.pca=T, nae="YES",thresh.espace.z=0.001, p.overlap=T, p.boxplot=F, p.scatter=T,run.silent=F)
...
humboldt.doitall <- function(inname = "DoItAll", env1, env2, sp1, sp2, rarefy.dist = 0, rarefy.units = "dd", env.reso, 
    ...
    humboldt.plot.niche(z5, title = "E-space Species 1", name.axis1 = "PC1", name.axis2 = "PC2", 
        correct.env = F)
